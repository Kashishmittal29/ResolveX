...
const topics = [
  { name: 'NodeJS', path: '/nodejs', icon: '🟢' },
  { name: 'GIT', path: '/git', icon: '🔀' },
  { name: 'MySQL', path: '/mysql', icon: '🗄️' },
  { name: 'Sequelize', path: '/sequelize', icon: '🔗' },
  { name: 'Sockets', path: '/sockets', icon: '🔌' },
  { name: 'E-Commerce', path: '/ecommerce', icon: '🛒' },
  { name: 'GraphQL', path: '/graphql', icon: '📊' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              A comprehensive full-stack project demonstrating modern web development 
              with NodeJS, MySQL, Sequelize, Socket.io, and GraphQL.
            </p>
        ...
        <div className="border-t border-dark-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} ResolveX. Built with React, NodeJS, and more.
          </p>
          <div className="flex gap-6 text-sm">
            ...
            <a href="#" className="text-gray-500 hover:text-gray-400 transition-colors">Contact</a>
          </div>
        </div>
      </div>
    </footer>
